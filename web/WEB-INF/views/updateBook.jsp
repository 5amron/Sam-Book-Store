...
<div class="container marketing">
    ...
    <div class="container">
        <div class="page-header">
            ...
            <p class="lead">update the below fields about book details :</p>
        </div>

        <%--this enctype property is for uploading file!!!!!!--%>
        <form:form action="${pageContext.request.contextPath}/admin/bookInventory/updateBook" method="post" commandName="book" enctype="multipart/form-data">

            <%--this form is because of a bug that came up because bookId was null (it debuged by the guy Le you remember?--%>
            <%--but it's hidden because we don't need to show it--%>
            ...
            <div class="form-group">
                ...
                <form:input path="bookPubDate" id="pubDate" class="form-Control" value="${book.bookPubDate}"/>
            </div>


            <div class="form-group">
                <label for="bookAuthor">Author</label>
                <form:input path="bookAuthor" id="author" class="form-Control" value="${book.bookAuthor}"/>
            </div>

            <div class="form-group">
                <label for="bookPageNum">Page number</label>
                <form:input path="bookPageNum" id="pageNum" class="form-Control" value="${book.bookPageNum}"/>
            </div>
